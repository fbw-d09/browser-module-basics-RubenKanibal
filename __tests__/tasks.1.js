...
describe("Import", () => {
    it("`index.js` imports `clickImages` from from `click.js`", async () => {
        const clickJs = fs
    ...
    it("`index.js` imports `hoverHeader` from `hover.js`", async () => {
        const hover = fs
            .readFileSync("./modules/index.js")
            .toString("utf-8")
            .replace(/ /g, "");
    ...
    it("`index.js` imports `scrollWindow` from `scroll.js`", async () => {
        const scroll = fs
            .readFileSync("./modules/index.js")
            .toString("utf-8")
            .replace(/ /g, "");
    ...
    it("Imported functions are called in `index.js`", async () => {
...
describe("Usage on page", () => {
    it("`index.js` is included in HTML using `script` tag", async () => {
        const scriptTag = await page.$('script[src$="index.js"]');
